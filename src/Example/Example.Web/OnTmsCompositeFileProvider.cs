...
{
    public class OnTmsCompositeFileProvider : IFileProvider
    {
        private readonly IFileProvider[] _fileProviders;

        public OnTmsCompositeFileProvider(params IFileProvider[] fileProviders)
        {
            _fileProviders = fileProviders ?? new IFileProvider[0];
        }

        public OnTmsCompositeFileProvider(IEnumerable<IFileProvider> fileProviders)
        {
    ...
    public class OnTmsPhysicalFileProvider : IFileProvider
    {
        PhysicalFileProvider _p;
        string _baseFolder;
        string _relativeFolder;

        public OnTmsPhysicalFileProvider(string baseFolder, string relativeFolder)
        {
